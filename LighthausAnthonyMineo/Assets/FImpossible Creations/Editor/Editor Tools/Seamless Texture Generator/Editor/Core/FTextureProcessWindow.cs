...
namespace FIMSpace.FSeamlessGenerator
{
    public abstract class FTextureProcessWindow : EditorWindow
    {
        ...
        private void GeneratePreviewTexture(int previewSize)
        {
            ...
            previewWorkTex = new Texture2D(previewSize, previewSize, TextureFormat.ARGB32, false, true);
        ...
        {
            previewTex = new Texture2D(previewWorkTex.width, previewWorkTex.height, TextureFormat.ARGB32, false, true);
